...
db = mysql.connector.connect(host ="localhost",user = "root",password = 'khushbu1234',database='db')
cursor = db.cursor()

window=Tk()
window.title("Faridabad Library management system")

greet = Label(window, font = ('arial', 30, 'bold'), text = "Welcome to Faridabad Library")
